...
<template>
  <footer
    class="bg-white/5 sticky bottom-0 w-full border-t flex font-medium justify-evenly gap-4 text-xs backdrop-blur-sm border-white/8 z-1000 p-4 rounded-t-[1.25rem] z-10000"
  >
    <RouterLink
